  ...
  const onCurrencySelection = useCallback(
    (field: Field, currency: Currency) => {
      dispatch(
        selectCurrency({
          field,
          currencyId: currency instanceof Token ? currency.address : currency === ETHER ? 'POND' : ''
        })
      )
    },
    [dispatch]
...
const BAD_RECIPIENT_ADDRESSES: string[] = [
  '0x1d1f1A7280D67246665Bb196F38553b469294f3a', // v2 factory
  '0xf164fC0Ec4E93095b804a4795bBe1e041497b92a', // v2 router 01
  '0xFB76e9E7d88E308aB530330eD90e84a952570319' // v2 router 02
]
...
function parseCurrencyFromURLParameter(urlParam: any): string {
  if (typeof urlParam === 'string') {
    ...
    if (urlParam.toUpperCase() === 'FUSE') return 'FUSE'
    if (valid === false) return 'FUSE'
  }
  return 'FUSE' ?? ''
}
